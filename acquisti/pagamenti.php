...
?>
<form action="acquisti/carica_importo.php" method="post" >
<table id="pannello_controllo">
	<tr id="titolo">
		<th>Pagamento Personalizzato</th>
	</tr>
	<tr><th>
<table id="pannello_controllo" style="width: 40%;">
				...
				<tr>
					...
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="nome" name="nome" maxlength="45" size="30" value="<?php if(isset($_SESSION['nome'])){ echo $_SESSION['nome'];}?>" >
					...
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="cognome" name="cognome" maxlength="45"
								size="30" value="<?php if(isset($_SESSION['cognome'])){echo $_SESSION['cognome'];}?>">
							<script type="text/javascript">
				...
				<tr>
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="via" name="via" maxlength="255" size="30" value="<?php if(isset($_SESSION['via'])){ echo $_SESSION['via'];}?>">
							<script type="text/javascript">
					...
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="n_civico" name="n_civico" maxlength="6"
								size="30" value="<?php if(isset($_SESSION['n_civico'])){echo $_SESSION['n_civico'];}?>">
							<script type="text/javascript">
					...
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="citta" name="citta" maxlength="255"
								size="30" value="<?php if(isset($_SESSION['citta'])){echo $_SESSION['citta'];}?>">
							<script type="text/javascript">
					...
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="provincia" name="provincia" maxlength="2"
								size="30"  value="<?php if(isset($_SESSION['provincia'])){echo $_SESSION['provincia'];}?>">
							<script type="text/javascript">
				...
				<tr>
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="cap" name="cap" maxlength="5" size="30" value="<?php if(isset($_SESSION['cap'])){ echo $_SESSION['cap'];}?>">
							<script type="text/javascript">
					...
					<th valign="middle" align="center" height="60" width="98">
						...
						<p>
							<input type="text" id="cf" name="cf" maxlength="16" size="30" value="<?php if(isset($_SESSION['cf'])){ echo $_SESSION['cf'];}?>">
							<script type="text/javascript">
		...
		<th>
			...
			<p>
				<input type="text" id="descrizione" name="descrizione"
					maxlength="255" size="30"  value="<?php if(isset($_SESSION['descrizione'])){echo $_SESSION['descrizione'];}?>">
				<script type="text/javascript">
			...
			<th>
						...
						<p>
							<input type="text" id="prezzo" name="prezzo" maxlength="10" size="30" value="<?php if(isset($_SESSION['prezzo'])){echo $_SESSION['prezzo'];}?>">
							<script type="text/javascript">
		...
		<th>
			...
			<p>
				<input type="text" id="qta" name="qta"
					maxlength="255" size="30" value="<?php if(isset($_SESSION['qta'])){echo $_SESSION['qta'];}?>">
				<script type="text/javascript">
			...
			<th>
						...
						<p>
							<input type="text" id="importo" name="importo" maxlength="10" size="30" value="<?php if(isset($_SESSION['importo'])){ echo $_SESSION['importo'];}?>">
							<script type="text/javascript">
		...
		<th colspan="2">
			...
			<p>
				<input type="text" id="note" name="note"
					maxlength="255" size="50" readonly value="Pagamento online tramite Carta di Credito">
				<script type="text/javascript">
